        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-6">
            <ScrollReveal direction="left" delay={100}>
              <div className="bg-[#2A2438] border border-gray-700/50 rounded-lg p-5 hover:border-purple-400/50 transition-colors">
          ...
          <ScrollReveal direction="right" delay={100}>
            <div className="bg-[#2A2438] border border-gray-700/50 rounded-lg p-6 lg:p-8">
              {emailSubmitted ? (
